...
CREATE UNIQUE NONCLUSTERED INDEX UQ_Category_Name ON dbo.Category([Name] ASC)
go
...
CREATE UNIQUE NONCLUSTERED INDEX UQ_Genre_Name ON dbo.Genre([Name] ASC)
go
...
CREATE UNIQUE NONCLUSTERED INDEX UQ_Type_Name ON dbo.[Type]([Name] ASC)
go
...
/* Delete foreign keys
ALTER TABLE Book DROP CONSTRAINT FK_Book_Items
go
ALTER TABLE Customer DROP CONSTRAINT FK_Customer_Person
go
ALTER TABLE DVD DROP CONSTRAINT FK_DVD_Items
go
ALTER TABLE Employee DROP CONSTRAINT FK_Employee_Person
ALTER TABLE ItemCopy DROP CONSTRAINT FK_ItemCopy_Items
go
ALTER TABLE Items DROP CONSTRAINT FK_Items_Type
ALTER TABLE Items DROP CONSTRAINT FK_Items_Category
go
ALTER TABLE Items DROP CONSTRAINT FK_Items_Genre
go
ALTER TABLE Rent DROP CONSTRAINT FK_Rent_Customer
go
ALTER TABLE RentDetail DROP CONSTRAINT FK_RentDetail_Rent
go
ALTER TABLE RentDetail DROP CONSTRAINT FK_RentDetail_ItemCopy
go
ALTER TABLE Reservation DROP CONSTRAINT FK_Reservation_Customer
go
ALTER TABLE Reservation DROP CONSTRAINT FK_Reservation_ItemCopy
go
ALTER TABLE Reservation DROP CONSTRAINT FK_Reservation_Rent
go
ALTER TABLE Software DROP CONSTRAINT FK_Software_Items
go
*/
